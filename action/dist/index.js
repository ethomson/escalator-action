...
function parseUrl(inputUrl) {
    ...
    const serverUrl = url_1.default.parse(inputUrl);
    if ((serverUrl.protocol != 'http:' && serverUrl.protocol != 'https:') || !serverUrl.hostname) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const payload = fs_1.default.readFileSync(payloadPath, 'utf8');
            ...
            return new Promise((resolve, reject) => {
                const proto = (serverUrl.protocol == 'https:') ? https_1.default : http_1.default;
                const request = proto.request(options);
                request.on('response', (response) => {
                    if (response.statusCode != 200 && response.statusCode != 204) {
                        reject(new Error(`Invalid response: ${response.statusCode} ${response.statusMessage}`));
                    }
